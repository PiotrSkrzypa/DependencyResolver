...
/* This script was created by  Hibzz Games and is licensed under the Creative Commons Attribution 4.0 International License (https://github.com/hibzzgames/Hibzz.DependencyResolver?tab=CC-BY-4.0-1-ov-file). Changes were made to the original. */

namespace PSkrzypa.DependencyResolver
{
    [InitializeOnLoad]
    public class DependencyResolver
    {
        private static AddAndRemoveRequest s_packageInstallationRequest;
        ...
        private static bool GetDependencies(PackageInfo packageInfo, out List<string> dependencies)
        {
        ...
        private static void InstallDependencies(List<string> dependencies)
        {
            ...
            s_packageInstallationRequest = Client.AddAndRemove(dependencies.ToArray(), null);
        ...
        private static string GetPrintFriendlyName(List<string> dependencies)
        {
        ...
        {
            if (s_packageInstallationRequest.IsCompleted)
            {
